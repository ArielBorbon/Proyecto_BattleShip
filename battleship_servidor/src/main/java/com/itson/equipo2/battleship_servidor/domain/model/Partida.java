...
public class Partida {
   private final UUID id;
    ...
    public void unirseAPartida(Jugador jugador2, UUID idTurnoInicial) {
    ...
    public ResultadoDisparo realizarDisparo(UUID jugadorId, CoordenadaDTO coordenada) {
    ...
    public Tablero getTableroJugador1() { return tableroJugador1; }
    public Tablero getTableroJugador2() { return tableroJugador2; }
    public EstadoPartida getEstado() { return estado; }
    public void setEstado(EstadoPartida estado) { this.estado = estado; }
    public UUID getTurnoActual() { return turnoActual; }
    public void setTurnoActual(UUID turnoActual) { this.turnoActual = turnoActual; }
}
