...
//
//        JugadorModel jm1 = new JugadorModel(JUGADOR_LOCAL_ID, "Juan", Color.RED, true, new TableroModel(new CeldaModel[10][10]),
//                new ArrayList<>());
//        JugadorModel jm2 = new JugadorModel(JUGADOR_OPONENTE_ID, "John", Color.BLUE, true, new TableroModel(new CeldaModel[10][10]),
//                new ArrayList<>());
//
...
//        RealizarDisparoService ts = new RealizarDisparoService(publisher, jm1);
